package com.example.mytodoapp.Task
...
import com.example.mytodoapp.Utils.Constant
import com.example.mytodoapp.Utils.Constant.clickDataPicker
import com.example.mytodoapp.Utils.Constant.showTimePicker
import com.example.mytodoapp.ViewModel.TodoModel
            ...
            R.id.addplan->{
                ...
                when{
                    ...
                    endtime.isEmpty() -> {
                        ...
                        Toast.makeText(this, "Task Set Successfully", Toast.LENGTH_SHORT).show()
